...
describe('Events Test', function() {
	...
	describe('Username', function () {
		...
		it('should not say anything when valid', function() {
			username.sendKeys(protractor.Key.BACK_SPACE, protractor.Key.BACK_SPACE, protractor.Key.BACK_SPACE, protractor.Key.BACK_SPACE, protractor.Key.BACK_SPACE, protractor.Key.BACK_SPACE);
